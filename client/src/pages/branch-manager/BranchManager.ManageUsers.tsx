...
function StatCardsSection({ users }: StatCardsProps) {
    ...
    const StatCard = ({ title, value, icon, iconColor }: { title: string; value: number; icon: any; iconColor: any }) => (
            ...
            <Card.Body className="py-4 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        <Text size="description" variant="slate-medium" weight="medium">{title}</Text>
                        <Text size="large" variant="black" weight="bold">{value}</Text>
                    </div>
                </div>
...
function ControlsSection({ searchQuery, setSearchQuery, setRoleFilter, setBranchFilter, setStatusFilter }: ControlsProps) {
    return (
        <Card isGlass={false}>
